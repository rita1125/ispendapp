...
function App() {
  ...
  const { t, i18n } = useTranslation();  // useTranslation 是 react-i18next 鉤子，t : 翻譯函數，i18n 是 i18next 的一個實例
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      <div className="grow"> 
        ...
        {/* 路由 & 組件 */}
        <div className="container mx-auto px-4 my-5 w-full">
          {allRoutes}
          {/* <Routes>
      ...
      <footer className="bg-sky-950 text-white py-4 text-center">
